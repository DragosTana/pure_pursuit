#ifndef TEST_SEGMENT_QUELLO_COL_CODICE_DELL_ARTICOLO_CHE_EFFETIVAMETNE_FA
#define TEST_SEGMENT_QUELLO_COL_CODICE_DELL_ARTICOLO_CHE_EFFETIVAMETNE_FA

#include "testbase.hpp"
#include "../geometry.hpp"

void cooler_test_segment_intersects() {
    test_suite(the cooler segment circle intersects) {
        ...
        test_case(guarda guarda sto segmento del cazzo che non fa niente) {
            ...
            double r = 6;
            std::vector<Point> intersects = segment_intersections(s, c, r);
        ...
        test_case(base interseca due punti) {
            ...
            auto intersects = segment_intersections(s, c, r);
        ...
        test_case(base non interseca) {
            ...
            auto intersects = segment_intersections(s, Point(0,0), 1);
