...
class ControlView():
    ...
    # Parameters:
        - initial_pos: the initial position of the car
        - way_points: the list of way points
        - show_old_pos: if True, the old positions of the car will be shown    
    """

    def __init__(self, initial_pos, way_points, show_old_pos = False, show_horizon = False):
    ...
    def refresh(self, startPoint, position, goal_point, horizon):
        ...
        # Parameters:
            - position: the new position of the car 
